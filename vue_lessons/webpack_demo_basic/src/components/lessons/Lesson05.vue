<template>
  <div id="lesson-05">
    ...
    <div id="example-05"
      ...
      <div id="bind-method">
        <ul>
          <li v-for="(n, idx) in notEven(numbers)"
              v-bind:key="idx">
            {{ n }}
          </li>
        </ul>
    ...
    <div id="example-06"
         v-if="seen6">
      <h2>Example 06, v-for mix with v-if</h2>
    ...
    <div id="example-07"
      ...
      <button v-on:click="changeLoginType">Toogle login type</button>
    </div>
  </div>
</template>
